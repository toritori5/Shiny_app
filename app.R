...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      textInput("gene", "Enter Gene Name:", value = "Tfap2b"),
      ...
      textInput("gene_x", "X-axis Gene:", value = "Jag1"),
      textInput("gene_y", "Y-axis Gene:", value = "Hoxa13"),
      textInput("gene_color", "Color by Gene:", value = "Tfap2b"),
      ...
      textInput("gene_count", "Enter Gene Name:", value = "Jag1"),
